...
def user_input_features():
    ...
    bloodpressure = st.sidebar.slider('BloodPressure - Kan Basıncı', 70.00, 123.00, 70.00)
    skinthickness = st.sidebar.slider('SkinThickness - Cilt Kalınlığı', 2.00, 99.00, 2.00)
    insulin = st.sidebar.slider('Insulin - Insulin Değeri', 100.00, 846.00, 800.00)
